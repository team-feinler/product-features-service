module.exports.featuresTableRecord = {
  feature_banner_header: "'a'",
  feature_banner_text_1: "'b'",
  feature_banner_text_2: "'c'",
  feature_setup_header: "'d'",
  feature_setup_description_1: "'e'",
  feature_setup_description_2: "'f'",
  feature_setup_description_3: "'g'",
  additional_features_header: "'h'",
  additional_features_description: "'i'",
};

module.exports.featuresListTableRecord = {
  header: "'a'",
  description: "'b'",
};

module.exports.contentGridTableRecord = {
  title: "'a'",
  description: "'b'",
};

module.exports.fullFakeDataRecord = {
  productId: 10000001,
  banner: {
